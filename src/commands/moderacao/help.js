    ...
    async execute(interaction) {
        ...
        const pagina01 = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: '/esforço', value: '*Marque quem não faz um esforço 😴*', inline: true },
                { name: '/duvida', value: '*Tire sua duvida com alguém 📝*', inline: true },
                { name: '/event-canonic', value: '*Evento Canônico Be Like 🕸️*', inline: true },
                { name: '/good-morning', value: '*Menssagem de bom dia ☀️*', inline: true },
